...
USER_COMMANDS: list[CmdSpec] = [
    ...
    CmdSpec("image", "生成图片(回复图片=图生图)"),
    CmdSpec("video", "生成视频(回复图片=图生视频)"),
    CmdSpec("tts", "文本转语音"),
    CmdSpec("music", "生成音乐"),
    CmdSpec("clone", "音色复刻(回复语音)"),
    CmdSpec("voices", "查询可用音色"),
    CmdSpec("design_voice", "音色设计"),
    CmdSpec("search", "联网搜索"),
...
def build_help_html() -> str:
    ...
    parts = [
        ...
        _group("生成", USER_COMMANDS[8:15]),
        _group("联网", USER_COMMANDS[15:17]),
